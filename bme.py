...
while True:
    ...
    if hack - t_print > 10:
        ...
        dewp = round((temp + 273.15) * math.sqrt(1 + ((temp + 273.15) * math.log(humi / 100)) / (
                (3.167485 - .00244 * (temp + 273.15)) * 1000000 / 461.5)) - 273.15, 1)

        # MDA
        mda = "IIMDA," + str(inch) + ",I," + str(round(bars, 2)) + ",B," + str(temp) + ",C," + mtw + ",C," + str(
            humi) + ",," + str(dewp) + ",C,,,,,,,,"
